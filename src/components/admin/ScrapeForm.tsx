...
export default function ScrapeForm({ onScrapeStarted }: ScrapeFormProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      <p className="text-gray-600 mb-4">Enter a URL to scrape and convert to markdown</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#00AFEF] focus:border-transparent"
            disabled={loading}
          />
        </div>
