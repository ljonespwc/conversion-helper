...
export default function ScrapeForm({ onScrapeStarted }: ScrapeFormProps) {
  ...
  return (
    <div className="bg-white rounded-3xl shadow-xl border border-gray-200 p-6">
      <h2 className="text-xl font-bold text-gray-900 mb-4">Scrape New Page</h2>
      <p className="text-gray-600 mb-4">Enter a URL to scrape and convert to markdown (5MB max, auto-retries on timeout)</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 bg-gray-100 border border-gray-300 text-gray-900 rounded-lg focus:ring-2 focus:ring-orange-400 focus:border-transparent placeholder-gray-400"
            disabled={loading}
          />
        </div>
