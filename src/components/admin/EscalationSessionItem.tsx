...
export default function EscalationSessionItem({
  ...
  function getToggleButtonClass(): string {
    ...
    if (escalation.resolved) {
      return 'bg-orange-900/30 hover:bg-orange-900/50 text-orange-400'
    }
    return 'bg-green-900/30 hover:bg-green-900/50 text-green-400'
  }
      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4 flex-1">
            <ChevronIcon className="w-5 h-5 text-gray-400 flex-shrink-0" />
