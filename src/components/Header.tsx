        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 min-w-0">
            <Link href="/" className="min-w-0" onClick={closeMobileMenu}>
              ...
              <p className="text-white/90 text-xs sm:text-sm mt-0.5 hidden sm:block">
                AI-powered voice assistant for your website. No hallucinations.
              </p>
            </Link>
          </div>
          ...
          {!loading && user && (
            <div className="hidden lg:flex items-center gap-2 flex-shrink-0">
              ...
              {/* User Email Display */}
              <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/20 backdrop-blur text-white text-sm">
                ...
                {user ? (
                  <>
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/20 hover:bg-white/30 backdrop-blur transition-all duration-200 text-white"
      ...
      {!loading && user && isMobileMenuOpen && (
        <div className="lg:hidden border-t border-white/20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 space-y-2">
            ...
            {/* User Email */}
            <div className="flex items-center gap-2 px-4 py-3 rounded-xl bg-white/20 backdrop-blur text-white text-sm">
              <User className="w-4 h-4" />
