...
export default function TestPage() {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="max-w-4xl mx-auto px-8 py-12 text-gray-400 space-y-6">
        <h1 className="text-3xl font-bold text-white">Lorem Ipsum Dolor Sit Amet</h1>
        ...
        <h2 className="text-2xl font-semibold text-gray-200 pt-4">Nemo Enim Ipsam Voluptatem</h2>
        ...
        <h2 className="text-2xl font-semibold text-gray-200 pt-4">At Vero Eos Et Accusamus</h2>
        ...
        <h2 className="text-2xl font-semibold text-gray-200 pt-4">Itaque Earum Rerum</h2>
