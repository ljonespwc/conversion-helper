      ...
      <main>
        ...
        <section className="blog-hero">
          <div className="blog-container">
            ...
            <p className="blog-subtitle">EasyAsk is AI trained on your content, giving it the power to sell products, capture leads, and answer every question.</p>
            <div className="blog-cta-wrapper">
              <a href="/pricing" className="landing-button-cta landing-button-large landing-button-pulse">
                See Pricing &rarr;
              </a>
              <p className="blog-hero-microcopy">Your content. No hallucinations. Works in 50+ languages.</p>
            </div>
            <div>
              <img
                src="/images/hero.png"
