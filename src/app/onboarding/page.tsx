      ...
      <div className="bg-white border border-gray-200 rounded-2xl shadow-2xl p-6 sm:p-8 w-full max-w-md">
        ...
        <form className="space-y-4">
          ...
          <div>
            ...
            <div className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-gray-100 border border-gray-300 text-gray-600 rounded-lg text-sm sm:text-base">
              {user.email}
            </div>
          </div>
          ...
          {/* Organization Name */}
          <div>
            <label htmlFor="organizationName" className="block text-sm font-medium text-gray-600 mb-2">
          ...
          {/* Website URL */}
          <div>
            <label htmlFor="websiteUrl" className="block text-sm font-medium text-gray-600 mb-2">
            ...
            />
            <p className="text-xs text-gray-500 mt-2">Where your AI assistant will be deployed</p>
          </div>
